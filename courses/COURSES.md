...
| :--------------------------------------------------- | :-------------- | :--: | :------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Профессия — Белый Хакер**                          | CyberED(Stepik) | 🇷🇺 | `#FullCourse` `#Beginner` `#Web` `#OSINT` `#Interactive`       | [Пройти](https://stepik.org/course/%D0%9F%D1%80%D0%BE%D1%84%D0%B5%D1%81%D1%81%D0%B8%D1%8F-%D0%91%D0%B5%D0%BB%D1%8B%D0%B9-%D0%A5%D0%B0%D0%BA%D0%B5%D1%80-169003/) |
| **"Компьютерная безопасность": курс для начинающих** | KznCTF          | 🇷🇺 | `#CTF` `#Networks` `#Basics` `#Pwn` `#Beginner` `#Interactive` | [Пройти](https://stepik.org/227129)                                                                                                                              |
...
| :--------------------------------------------------- | :---------------------------- | :--: | :--------------------------- | :------------------------------------------------------------------------------------------------------------------ |
|                                                      |                               |      |                              |                                                                                                                     |
| **Полный курс по взлому веб-приложений: Pro Hacker** | Ethical Hacking for Beginners | 🇷🇺 | `#Web` `#Bounty` `#Begginer` | [Смотреть]([https://...](https://youtube.com/playlist?list=PLrNhNTukZ_nEMnLjekejjT2mzxpd8OKdb&si=HZ7YhsPcXSrglhWn)) |
...
| Название                                                                                      | Автор / Канал | Язык | Теги                                 | Ссылка                                                                                               |
| :-------------------------------------------------------------------------------------------- | :------------ | :--: | :----------------------------------- | :--------------------------------------------------------------------------------------------------- |
| **Binary Exploitation / Memory Corruption by LiveOverflow**                                   | LiveOverflow  | 🇬🇧 | `#Pwn` `#ASM` `#exploit` `#cracking` | [Смотреть](https://youtube.com/playlist?list=PLhixgUqwRTjxglIswKp9mpkfPNfHkzyeN&si=naxa0U1mpQY_2z2k) |
| **Intro to Binary Exploitation (Pwn) - Practical Buffer Overflow Challenges (for beginners)** | CryptoCat     | 🇷🇺 | `#Pwn` `#exploit`                    | [Смотреть](https://youtube.com/playlist?list=PLHUKi1UlEgOIc07Rfk2Jgb5fZbxDPec94&si=LfT5EYCP30uVOKgZ) |
